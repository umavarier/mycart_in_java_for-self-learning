package com.uma.mycart.entities;
...
public class User {
    ...
    public void setUserAdderess(String userAddress) {
        this.userAddress = userAddress;
    }
    ...
    public String toString() {
        return "User{" + "userId=" + userId + ", userName=" + userName + ", userEmail=" + userEmail + ", userPassword=" + userPassword + ", userPhone=" + userPhone + ", userPic=" + userPic + ", userAdderess=" + userAddress + '}';
    }
